...
// http://web.archive.org/web/20170603213006/https://mamibuy.com.tw/index.aspx

class NavigationManArchive extends EventEmitter {
  constructor (parentEmitter) {
    super()
    this._timeout = 65000 // could be 30 seconds
    this._idleTime = 2000 // could be 1500 (1.5 seconds)
    this._idleInflight = 0 // could be 4
  ...
  startedNav (curURL) {
    ...
    this._navFinished = null
    this._doneTimers = false
    this._navTimeout = setTimeout(this._navTimedOut, 10000)
...
module.exports = NavigationManArchive
